...
<body class="bg-[#181a1b] text-[#e8e6e3]">
    <header class="flex m-5 items-center justify-center bg-zinc-900">
        <h1 class="text-2xl font-bold">Halo Reach</h1>
    </header>
    ...
    <div class="flex m-10 items-center justify-center bg-zinc-900">
    ...
    <div class="flex my-5">
        <div class="w-1/2 h-64 px-5">
            <img class=" w-full h-full object-cover" src="{{url('/assets/imagenes/kat_home.jpg')}}" alt="">
        </div>
        <div class="w-1/2 flex items-center justify-center">
            <div class="mx-10" >
    ...
    <div class="flex my-5">
        ...
        <div class="w-1/2 h-64 px-5">
            <img class=" w-full h-full object-cover" src="{{url('/assets/imagenes/jun_home.jpg')}}" alt="">
        </div>
    </div>
    <div class="flex my-5">
        <div class="w-1/2 h-64 px-5">
            <img class=" w-full h-full object-cover" src="{{url('/assets/imagenes/emile_home.jpg')}}" alt="">
        </div>
        <div class="w-1/2 flex items-center justify-center">
            <div class="mx-10" >
    ...
    <div class="flex my-5">
        ...
        <div class="w-1/2 h-64 px-5">
            <img class=" w-full h-full object-cover" src="{{url('/assets/imagenes/jorge_home.jpg')}}" alt="">
        </div>
    </div>
    <div class="flex my-5">
        <div class="w-1/2 h-64 px-5">
            <img class=" w-full h-full object-cover" src="{{url('/assets/imagenes/noble6_home.jpg')}}" alt="">
        </div>
        <div class="w-1/2 flex items-center justify-center">
            <div class="mx-10" >
